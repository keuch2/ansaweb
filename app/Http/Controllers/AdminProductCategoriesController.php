<?php namespace App\Http\Controllers;
	...
	class AdminProductCategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Nombre categoria de producto","name"=>"category_name"];
			$this->col[] = ["label"=>"Imagen","name"=>"photo","image"=>true];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Nombre categoria de producto','name'=>'category_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
