<?php namespace App\Http\Controllers;
	...
	class AdminProductPhotosController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Producto","name"=>"product_id","join"=>"products,product_name"];
            ...
            if (isset($_GET['product_id'])) {
                ...
                $this->form[] = ['label'=>'Producto','name'=>'product_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'products,product_name'];
            }
