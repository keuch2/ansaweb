<?php namespace App\Http\Controllers;
	...
	class AdminTiresController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "tire_name";
			$this->limit = "20";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Codigo","name"=>"tire_code"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Codigo','name'=>'tire_code','type'=>'text','validation'=>'min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nombre neumatico','name'=>'tire_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Tipo neumatico','name'=>'tire_type','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'RADIAL;CONVENCIONAL'];
			...
			$this->form[] = ['label'=>'Porcentaje de descuento','name'=>'discount_rate','type'=>'number','validation'=>'required|min:0|max:100|numeric','width'=>'col-sm-10', 'help'=>'Porcentaje de descuento a aplicar al precio base del neumatico (Entero entre 0% y 100%)'];
			...
			//$this->form[] = ['label'=>'Perfil','name'=>'profile_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'profiles,profile_name'];
			//$this->form[] = ['label'=>'Descripcion','name'=>'description','type'=>'wysiwyg','validation'=>'string|min:5|max:5000','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Precio base','name'=>'price','type'=>'number','validation'=>'required|min:0|numeric','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Discount Rate','name'=>'discount_rate','type'=>'number','validation'=>'required|min:0|numeric','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Precio final','name'=>'final_price','type'=>'number','validation'=>'min:0|numeric','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Estado','name'=>'state','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'ACTIVO;INACTIVO'];
			//$this->form[] = ['label'=>'Destacado','name'=>'featured','type'=>'checkbox','width'=>'col-sm-10','dataenum'=>'1|SI'];
			//$this->form[] = ['label'=>'Contador de visitas','name'=>'visit_counter','type'=>'number','validation'=>'integer|min:0','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Imagen principal','name'=>'photo','type'=>'upload','validation'=>'required|image|max:10000','width'=>'col-sm-10','help'=>'Tipo de imágenes soportados: JPG, JPEG, PNG, GIF, BMP', 'upload_encrypt'=>'true'];
	        ...
	        */
            ...
            // View Tires photos
            $this->sub_module[] = ['label' => 'Imagenes', 'path' => 'tire_photos', 'parent_columns' => 'tire_name,tire_code', 'foreign_key' => 'tire_id', 'button_color' => 'success', 'button_icon' => 'fa fa-photo', 'parent_columns_alias' => 'Neumatico,Codigo'];

            // Action Button In Grid Data (New Tire Photo)
            $this->addaction[] = ['label' => 'Agregar imagen', 'url' => CRUDBooster::mainpath('../tire_photos/add/?tire_id=[id]'), 'icon' => 'fa fa-plus', 'color' => 'info'];
